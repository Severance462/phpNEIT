<nav class="navbar navbar-inverse">
	  <div class="container-fluid">
		<div class="navbar-header" style="height:5em">
		  ...
		  <a class="navbar-brand" href="../SE266/index.php">John Lougee</a>
		</div>
			<div class="collapse navbar-collapse" id="myNavbar">
			  <ul class="nav navbar-nav">
				<li><a href="../SE266/index.php">Home</a></li>				
				<li class="dropdown">
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li><a href="../SE266/Week1/creditCard.php">Week 1 - Credit Payoff Calculator</a></li>
					<li><a href="../SE266/actorIndex.php">Week 2 - Actor Database</a></li>
					<li><a href="../SE266/view-all.php">Week 3 - Companies Database</a></li>
				  </ul>
				</li> 				
			  </ul>
