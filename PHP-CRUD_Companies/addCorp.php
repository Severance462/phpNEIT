        ...
        <div class="container">        
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="form-group" method="post" action="addCorp.php">
							<label for="corp">Company Name</label>
							<input type="text" class="form-control" name="corp" placeholder="Company Name">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="incDate" placeholder="Company Incorporation Date">
					...
					<div class="col-md-2">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="owner" placeholder="Enter Company Owner">
				...
				<div class="row">
					<div class="col-md-2">
						<input type="submit" class="btn btn-primary" value="Add New Company" name="submit">	
					</div>
					<div class="col-md-2">					
		 ...
		 <?php
        if(isset($_POST['corp']) && ($_POST['email']) && ($_POST['zipcode']) && ($_POST['owner']) && ($_POST['phone']))
        { 
            ...
            $phone = filter_input(INPUT_POST, 'phone');                           
                ...
                $sqlState = $db->prepare("INSERT INTO corps SET corp = :corp, email = :email, zipcode = :zipcode, owner = :owner, phone = :phone");
