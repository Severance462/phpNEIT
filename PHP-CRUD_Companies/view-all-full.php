...
<?php include 'nav.php' ?>
        ...
        <?php
            ...
            $sqlState = $db->prepare("Select * from corps");
        ...
        <div class="jumbotron">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<a class='btn btn-info' href='view-all.php'>Search/Sort lite details</a>
				</div>
			</div>
            <br/>
            <br/>
			...
			<div class="row">
				<div class="col-md-3">				
					<?php include './form1full.php'; ?>
				</div>
				<div class="col-md-3">
				</div>
				<div class="col-md-6">
					<?php include './form2full.php'; 
                        ...
                        <?php 
                            foreach ($results as $row): ?>
                                <tr class="row">   								
                                    ...
                                    <td class="col-sm-2"><?php echo $row['corp']; ?></td>
                                    <td class="col-sm-1"><?php echo $row['incorp_dt']; ?></td>
                                    <td class="col-sm-2"><?php echo $row['email']; ?></td>
                                    <td class="col-sm-1"><?php echo $row['zipcode']; ?></td>
									<td class="col-sm-2"><?php echo $row['owner']; ?></td>
									<td class="col-sm-3"><?php echo $row['phone']; ?></td>
                                </tr>
                        <?php endforeach;?>                
                    </tbody>
